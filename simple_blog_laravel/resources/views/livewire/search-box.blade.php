<div id="search-box">
    <div>
        ...
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            {{--by writing this in input 'Wire:model.live.debounce.300ms="search"' it makes the value update as we type in search box but it has a problem of it's gonna send a lot of requests sp we'll add a search button and i'll check in after 300ms from the user stop writing --}}
