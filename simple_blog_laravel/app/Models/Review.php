...
class Review extends Model
{
    ...
    {    //as it many to many it should be wherehas as it gives the ability to filter out or search based on a relationship
        ...
        //first argument is the relationship name which is genres (name of the method) in this file which is belongs to many
    ...
    //show only 150 letter of the review
    ...
    /* if image doesn't appear go to review-item and put it in the thumbnail img as $review->getThumbnailImage()
    //to show thumbnail imgs
